...
公开层使用两套独立门槛。截止日期、至少四天、线下形式、有效标题和安全官网链接属于一票否决的公开条件；资金可及性是更严格的推荐条件。有资助或总费用不超过 400 EUR 的项目进入“资助优选”，费用明确且通过总价和日均上限的项目进入“官网核实自费”层。费用和资助均未说明、但通过全部硬条件的当前官网项目可以进入“更多官网项目”，该层不作费用或资助推荐；已知昂贵课程不能借此重新进入。官网已核实的往届项目只进入明确标注已截止的周期项目库，不计入开放机会和 RSS。
