...
- MLSS Index: HTTPConnectionPool(host='mlss.cc', port=80): Max retries exceeded with url: / (Caused by ConnectTimeoutError(<urllib3.connection.HTTPConnection object at 0x000002178795D6A0>, 'Connection to mlss.cc timed out. (connect timeout=20)'))
- ISPRS: HTTPSConnectionPool(host='www.isprs.org', port=443): Max retries exceeded with url: / (Caused by ConnectTimeoutError(<urllib3.connection.HTTPSConnection object at 0x000002178B0AD0D0>, 'Connection to www.isprs.org timed out. (connect timeout=20)'))
- AMMI linked page https://applications.nexteinstein.org/appl-prev.php?appltype=AMMIIntake: HTTPSConnectionPool(host='applications.nexteinstein.org', port=443): Max retries exceeded with url: /appl-prev.php?appltype=AMMIIntake (Caused by NewConnectionError('<urllib3.connection.HTTPSConnection object at 0x000002178CD5D640>: Failed to establish a new connection: [WinError 10061] 由于目标计算机积极拒绝，无法连接。'))
