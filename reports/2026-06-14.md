...
- AMMI linked page https://applications.nexteinstein.org/appl-prev.php?appltype=AMMIIntake: HTTPSConnectionPool(host='applications.nexteinstein.org', port=443): Max retries exceeded with url: /appl-prev.php?appltype=AMMIIntake (Caused by NewConnectionError('<urllib3.connection.HTTPSConnection object at 0x0000017F5C359AF0>: Failed to establish a new connection: [WinError 10061] 由于目标计算机积极拒绝，无法连接。'))
