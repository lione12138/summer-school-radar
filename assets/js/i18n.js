(function(){
    var I18N = {
      ...
      "library.lead": {en:"Verified past editions from official sources. These are not open applications; use them to discover recurring schools and watch for the next call.", zh:"来自官网、已经核实的往届项目。这些项目当前不能申请，可用于发现长期举办的暑校并关注下一次开放。"},
      "library.count": {en:"Showing verified recurring programmes", zh:"当前展示已核实的周期项目"},
      "library.closed": {en:"Past edition · applications closed", zh:"往届项目 · 本期申请已结束"},
