(function(){
    var I18N = {
      ...
      "stat.qualified": {en:"Funded / low fee", zh:"资助优选"},
      ...
      "filter.status.qualified": {en:"Funded / low fee", zh:"资助优选"},
      ...
      "tier.high.lead": {en:"Open programmes with clear official fees; listed separately from funded recommendations.", zh:"申请开放且官网费用明确；与资助优选分开展示，不代表获得资助。"},
