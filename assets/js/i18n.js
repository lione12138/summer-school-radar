(function(){
    var I18N = {
      ...
      "browse.label": {en:"Browse opportunities", zh:"浏览项目"},
      "browse.open": {en:"Open applications", zh:"当前可申请"},
      "browse.library": {en:"Past editions", zh:"历届项目库"},
      "home.information": {en:"Sources, methodology & frequently asked questions", zh:"来源、筛选方法与常见问题"},
      "action.edition": {en:"Edition details", zh:"本届详情"},
      "library.search": {en:"Search past editions", zh:"搜索历届项目"},
      "library.empty": {en:"No past editions match your search.", zh:"没有符合搜索条件的历届项目。"},
      "detail.coverage": {en:"See the overview for coverage and eligibility", zh:"查看项目概览中的覆盖范围与申请条件"},
      "detail.fee.evidence": {en:"Fee evidence", zh:"费用依据"},
      "detail.funding.evidence": {en:"Funding evidence", zh:"资助依据"},
      "sources.search": {en:"Search sources", zh:"搜索来源"},
      "sources.search.placeholder": {en:"Source, region, topic", zh:"来源名称、地区、主题"},
      "sources.details": {en:"Coverage details", zh:"覆盖详情"},
      "sources.all": {en:"All sources", zh:"全部来源"},
      "sources.attention": {en:"Needs attention", zh:"异常或尚未确认"},
      "sources.healthy": {en:"Fetch succeeded", zh:"抓取成功"},
      "sources.extraction": {en:"Extraction coverage", zh:"抽取覆盖情况"},
      "sources.empty": {en:"No sources match these filters.", zh:"没有符合条件的来源。"},
      ...
      "hero.kicker": {en:"All disciplines · Free & open source", zh:"不限学科 · 免费开源"},
      "hero.title": {en:"Find your next research school", zh:"寻找下一站科研训练"},
      "hero.subtitle": {en:"Funded and low-fee research training from official academic sources. Check dates, costs and eligibility before applying.", zh:"汇总官方学术来源的资助与低费用科研训练。申请前核对日期、费用和资格要求。"},
      ...
      "stat.qualified": {en:"Funded / low fee", zh:"资助或低费用"},
      "stat.near": {en:"Verified self-funded", zh:"官网核实自费"},
      "stat.sources": {en:"Trusted sources", zh:"可信来源"},
      "stat.updated": {en:"Last updated", zh:"最近更新"},
      "stat.scanned": {en:"Sources last scanned", zh:"来源最近扫描"},
      ...
      "filter.empty": {en:"No open applications match these filters.", zh:"没有符合当前筛选条件的开放申请项目。"},
      ...
      "filter.status.qualified": {en:"Funded / low fee", zh:"资助或低费用"},
      "filter.status.high": {en:"Verified self-funded", zh:"官网核实自费"},
      "filter.status.found": {en:"More official programmes", zh:"更多官网项目"},
      ...
      "filter.funding.self": {en:"Self-funded", zh:"需自费"},
      "filter.funding.unresolved": {en:"Funding / fee not stated", zh:"资助或费用未说明"},
      ...
      "tier.qualified": {en:"Funded and Accessible Recommendations", zh:"资助与高性价比优选"},
      "tier.high": {en:"Officially Verified Self-Funded Schools", zh:"官网已核实的自费项目"},
      "tier.found": {en:"More Official Programmes", zh:"更多官网项目"},
      "tier.curated": {en:"Curated Opportunities", zh:"人工精选项目"},
      "tier.high.lead": {en:"Open programmes with clear official fees; listed separately from funded recommendations.", zh:"申请开放且官网费用明确；与资助或低费用分开展示，不代表获得资助。"},
      "tier.found.lead": {en:"Open official programmes that meet the basic format rules; no funding or affordability recommendation is made.", zh:"申请状态明确开放且满足基本形式要求的官网项目；本栏目不对资助或费用性价比作推荐。"},
      ...
      "library.title": {en:"Past editions & recurring programmes", zh:"历届与周期项目"},
      "library.lead": {en:"Verified recurring programmes from official sources whose applications are closed. Event timing is shown separately; use these records to discover schools and watch for the next call.", zh:"来自官网、申请已经结束的周期性项目；活动时间状态单独标注，可用于发现长期举办的暑校并关注下一次开放。"},
      "library.count": {en:"Showing verified recurring programmes", zh:"当前展示已核实的周期项目"},
      "library.upcoming_closed": {en:"Upcoming · applications closed", zh:"即将举办 · 申请已结束"},
      "library.ongoing_closed": {en:"Ongoing · applications closed", zh:"正在举办 · 申请已结束"},
      "library.past_closed": {en:"Past edition · applications closed", zh:"往届项目 · 申请已结束"},
      "library.official": {en:"Official website ↗", zh:"前往官网 ↗"},
      "programme.back": {en:"← Back to programme library", zh:"← 返回历届项目库"},
      "programme.label": {en:"Recurring programme", zh:"周期性项目"},
      "programme.editions": {en:"Verified editions", zh:"已核实届次"},
      "programme.editions.lead": {en:"Each edition keeps its own dates, application status, fees, funding and official link.", zh:"每一届分别保留日期、申请状态、费用、资助和官方网站。"},
      "programme.pattern": {en:"Observed programme pattern", zh:"历届规律"},
      "programme.pattern.years": {en:"Edition years", zh:"已记录年份"},
      "programme.pattern.duration": {en:"Observed duration", zh:"历届时长"},
      "programme.pattern.months": {en:"Application months", zh:"申请月份"},
      "programme.pattern.venues": {en:"Previous venues", zh:"历届地点"},
      "programme.pattern.finances": {en:"Funding and fee history", zh:"资助与费用记录"},
      "programme.open": {en:"Applications open", zh:"申请开放"},
      "programme.view": {en:"Programme history", zh:"历届记录"},
      "topics.back": {en:"← Browse all opportunities", zh:"← 浏览全部项目"},
      "topics.label": {en:"Topic guide", zh:"主题指南"},
      "topics.programmes": {en:"Verified programmes", zh:"已核实项目"},
      "topics.home.title": {en:"Browse research schools by topic", zh:"按主题浏览科研暑校"},
      "topics.home.lead": {en:"Indexable topic guides are created only when enough verified programmes exist, avoiding thin pages.", zh:"只有在已核实项目数量足够时才生成可索引主题页，避免内容单薄。"},
      ...
      "detail.why": {en:"How this listing was assessed", zh:"项目收录依据"},
      "detail.source": {en:"Official source", zh:"官方来源"},
      "detail.source.original": {en:"Expand a field to check the original official evidence.", zh:"展开对应字段，核对保留的官网原文。"},
      ...
      "sources.lead": {en:"Official academic sources checked by Summa. See their coverage, latest successful scan and any collection issues.", zh:"Summa 定期检查的官方学术来源。这里可以查看覆盖范围、最近成功采集时间和采集异常。"},
      "sources.back": {en:"Back to opportunities", zh:"返回项目列表"},
      ...
      "sources.health": {en:"Fetch health", zh:"抓取健康状态"},
      "sources.last_success": {en:"Last success", zh:"上次成功"},
      "sources.failures": {en:"Failures", zh:"连续失败"},
      ...
      "how.3.body": {en:"Only genuine in-person research-training opportunities with an open deadline and acceptable financial access are treated as qualified; academic discipline is not a restriction.", zh:"只有真实的线下科研训练项目，在申请开放且费用或资助条件可接受时，才会被标为完全符合；学科方向不受限制。"},
      ...
      "foot.api": {en:"Public opportunity API", zh:"公开项目 API"},
      ...
      "foot.blurb": {en:"A free, open-source scanner for high-quality research summer schools, winter schools, and training schools in any academic discipline. Deadline status is refreshed daily.", zh:"一个免费的开源扫描器，追踪不限学科的优质科研暑校、冬校和训练学校。截止状态每日刷新。"},
