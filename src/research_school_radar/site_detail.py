...
def render_opportunity_detail(candidate: Candidate, site_config: dict[str, Any] | None = None) -> str:
    ...
    meta_description = seo_description(
        f"{candidate.title}. {summary} Dates: {duration}; location: {location}; "
        f"funding or fee: {financial_summary_short(candidate)}."
    )
    ...
    return render_template(
        ...
        calendar="" if archived or candidate.deadline_status != "open" else calendar,
